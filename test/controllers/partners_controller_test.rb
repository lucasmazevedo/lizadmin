...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { logo_image: @partner.logo_image, name: @partner.name, status: @partner.status, url: @partner.url } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { logo_image: @partner.logo_image, name: @partner.name, status: @partner.status, url: @partner.url } }
