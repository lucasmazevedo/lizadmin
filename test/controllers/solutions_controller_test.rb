...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { description: @solution.description, status: @solution.status, title: @solution.title } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { description: @solution.description, status: @solution.status, title: @solution.title } }
